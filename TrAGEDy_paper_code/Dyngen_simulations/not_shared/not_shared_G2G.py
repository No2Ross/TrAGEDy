...
adata_c = ad.read_h5ad(input_dir + 'negative_control_1_processed.h5ad') # PAM dataset
adata_d = ad.read_h5ad(input_dir + 'negative_control_2_processed.h5ad') # LPS dataset
...
gene_list = np.array(pd.read_csv(input_dir + "negative_control_feature_space.csv"))[:,1]

output_dir = "/Users/rosslaidlaw/R/TrAGEDy_V2/simulated_datasets/plots/"

alignment_subset = "IIIDIDIDIDIIIIIIIIIIIIIIDDDDDDDDDDDDDDDD"
...
if __name__ == '__main__':
    ...
    plt.savefig(output_dir + "notShared_heatmap_genes2genes_subsetGenes.png")
    plt.show()
...
#
#     aligner.get_aggregate_alignment()
#     plt.savefig(output_dir + "notShared_heatmap_genes2genes_allGenes.png")
#     plt.show()